...
const DemandeMaintenance = require('../models/Maintenance');

// ===========================================
// 1. ROUTES SPÉCIFIQUES (les plus précises d'abord)
// ===========================================

// GET demandes urgentes (la plus spécifique)
router.get('/urgentes/en-attente', async (req, res) => {
  try {
    const demandes = await DemandeMaintenance.find({
      'statut_id.nom': 'EN_ATTENTE'
    })
...
// ===========================================
// 2. ROUTES D'ACTION (avec paramètre ID)
// ===========================================
...
// READ ONE (à mettre APRÈS toutes les routes spécifiques)
